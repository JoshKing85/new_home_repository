'''
define function winning_numbers
This functions passes two lists as arguments. The lists are coverted to sets to check for values repeated in the two sets.
The size of the set will determine the index position used to extract elements from a different previously defined list.
The function will then print a message and return the element exracted.
